...
int main(int argc, char *argv[]) {
    ...
    while ((opt = getopt_long(argc, argv, "123456789pqrsaf:e:mwk:n", long_options, NULL)) != -1) {
        switch (opt) {
            ...
            case 'x': // --debug-exit
                ...
                break;
            default:
                puts("Usage: MushroomDpi.exe [OPTION...]\n"
                " -p          block passive DPI\n"
                " -q          block QUIC/HTTP3\n"
    ...
    printf("Pasif engelleme: %d\n"                     /* 1 */
           "QUIC/HTTP3 engelleme: %d\n"                /* 1 */
           "HTTP parcalama: %u\n"                      /* 2 */
           "Kalici HTTP parcalama: %u\n"                /* 3 */
           "HTTPS parcalama: %u\n"                      /* 4 */
           "SNI'ye gore parcalama: %u\n"                /* 5 */
           "Yerel parcalama (bolme): %d\n"              /* 6 */
           "Parcalari ters sirayla gonderme: %d\n"      /* 7 */
           "hoSt: %d\n"                                 /* 8 */
           "Host boslugu yok: %d\n"                     /* 9 */
           "Ek bosluk: %d\n"                            /* 10 */
           "Host buyuk/kucuk harf karistirma: %d\n"     /* 11 */
           "HTTP TumPortlar: %d\n"                      /* 12 */
           "HTTP Kalici Beklemesiz: %d\n"               /* 13 */
           "DNS yonlendirme: %d\n"                      /* 14 */
           "DNSv6 yonlendirme: %d\n"                    /* 15 */
           "SNI eksikligine izin ver: %d\n"             /* 16 */
           "Sahte istekler, TTL: %s (sabit: %hu, otomatik: %hu-%hu-%hu, min mesafe: %hu)\n"  /* 17 */
           "Sahte istekler, yanlis checksum: %d\n"      /* 18 */
           "Sahte istekler, yanlis SEQ/ACK: %d\n"       /* 19 */
           "Sahte istekler, ozel yukler: %d\n"          /* 20 */
           "Sahte istekler, yeniden gonderim: %d\n"     /* 21 */
           "Maksimum yuk boyutu: %hu\n",                /* 22 */
           ...
           do_allow_no_sni,                    /* 16 */
           do_auto_ttl ? "otomatik" : (do_fake_packet ? "sabit" : "kapali"),  /* 17 */
